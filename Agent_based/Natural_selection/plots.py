...
#     ax[1].set_yticklabels(["0\%", "25\%", "50\%", "75\%", "100\%"], fontsize = 12)
    ...
    ax[1].set_yticks([0,40,80,120,160,200])
    ax[1].set_yticklabels([0,40,80,120,160,200], fontsize = 12)
    ...
    ax[3].set_ylim(0, 5)
    ax[3].set_xticks([500*i for i in range(nsteps//500 + 1)])
    ax[3].set_xticklabels([500*i for i in range(nsteps//500 + 1)], fontsize = 12)
    ax[3].set_yticks([0,1,2,3,4,5])
    ax[3].set_yticklabels([0,1,2,3,4,5], fontsize = 12)
    ...
    if len(ax) == 6:
        ...
        ax[5].set_ylim(0, 3)
        ax[5].set_xticks([500*i for i in range(nsteps//500 + 1)])
        ax[5].set_xticklabels([500*i for i in range(nsteps//500 + 1)], fontsize = 12)
        ax[5].set_yticks([0.5*i for i in range(7)])
        ax[5].set_yticklabels([f"{0.5*i:.1f}" for i in range(7)], fontsize = 12)
